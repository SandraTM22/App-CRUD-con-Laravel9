<?php $__env->startSection('content'); ?>
    <div class="mx-auto text-xl flex justify-between items-center border-b-2 border-r-sky-900 mb-2 p-2">
        ...
        <a class="bg-teal-500 text-white hover:bg-teal-700 hover:text-white border shadow-inner hover:border-transparent rounded px-2" href="<?php echo e(route('Cursos.create')); ?>">Nuevo Post</a>
    </div>
...
<?php echo $__env->make('layaut', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/blog/blog.blade.php ENDPATH**/ ?>